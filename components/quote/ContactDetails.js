    ...
    return (
        <>
            <div className="p-4 md:p-5 lg:p-8 xl:p-10">
                    ...
                    <div className="text-sm opacity-50 mb-6">firstName</div>
                    <div className="text-sm opacity-50 mb-6">lastName</div>
                    <div className="text-sm opacity-50 mb-6">email</div>
                    <div className="text-sm opacity-50 mb-6">phone</div>
                    <div className="text-sm opacity-50 mb-6">companyName</div>
                    <div className="text-sm opacity-50 mb-6">termsAcceptedAt</div>
                    {/* <Textarea
